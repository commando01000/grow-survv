		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CompanyID] = _Department.PropertyNames.CompanyID;
					ht[ArName] = _Department.PropertyNames.ArName;
					ht[EnName] = _Department.PropertyNames.EnName;
					ht[IsActive] = _Department.PropertyNames.IsActive;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CompanyID] = _Department.ColumnNames.CompanyID;
					ht[ArName] = _Department.ColumnNames.ArName;
					ht[EnName] = _Department.ColumnNames.EnName;
					ht[IsActive] = _Department.ColumnNames.IsActive;
