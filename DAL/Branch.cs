		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[BranchID] = _Branch.PropertyNames.BranchID;
					ht[CompanyID] = _Branch.PropertyNames.CompanyID;
					ht[NameEn] = _Branch.PropertyNames.NameEn;
					ht[NameAr] = _Branch.PropertyNames.NameAr;
					ht[IsActive] = _Branch.PropertyNames.IsActive;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[BranchID] = _Branch.ColumnNames.BranchID;
					ht[CompanyID] = _Branch.ColumnNames.CompanyID;
					ht[NameEn] = _Branch.ColumnNames.NameEn;
					ht[NameAr] = _Branch.ColumnNames.NameAr;
					ht[IsActive] = _Branch.ColumnNames.IsActive;
