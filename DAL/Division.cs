...
{
	public abstract class _Division : SqlClientEntity
	{
		public _Division()
		{
			this.QuerySource = "Division";
			this.MappingName = "Division";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DivisionLoadAll]", parameters);
		}
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(int DivisionID)
		{
			ListDictionary parameters = new ListDictionary();
			parameters.Add(Parameters.DivisionID, DivisionID);

		
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_DivisionLoadByPrimaryKey]", parameters);
		}
		...
		{  
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[DivisionID] = _Division.PropertyNames.DivisionID;
					ht[CompanyID] = _Division.PropertyNames.CompanyID;
					ht[NameEn] = _Division.PropertyNames.NameEn;
					ht[NameAr] = _Division.PropertyNames.NameAr;
					ht[IsActive] = _Division.PropertyNames.IsActive;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[DivisionID] = _Division.ColumnNames.DivisionID;
					ht[CompanyID] = _Division.ColumnNames.CompanyID;
					ht[NameEn] = _Division.ColumnNames.NameEn;
					ht[NameAr] = _Division.ColumnNames.NameAr;
					ht[IsActive] = _Division.ColumnNames.IsActive;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DivisionInsert]";
	
			CreateParameters(cmd);
			
			SqlParameter p;
			p = cmd.Parameters[Parameters.DivisionID.ParameterName];
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DivisionUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_DivisionDelete]";
