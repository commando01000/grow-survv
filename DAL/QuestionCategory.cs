...
{
	public abstract class _QuestionCategory : SqlClientEntity
	{
		public _QuestionCategory()
		{
			this.QuerySource = "QuestionCategory";
			this.MappingName = "QuestionCategory";
		...
		public bool LoadAll() 
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_QuestionCategoryLoadAll]", parameters);
		}
		...
		public virtual bool LoadByPrimaryKey(int CategoryID)
		{
			...
			return base.LoadFromSql("[" + this.SchemaStoredProcedure + "proc_QuestionCategoryLoadByPrimaryKey]", parameters);
		}
		...
		protected class Parameters
		{
			...
			public static SqlParameter SureveyID
			{
				get
				{
					return new SqlParameter("@SureveyID", SqlDbType.Int, 0);
				}
			}
		...
		{  
            ...
            public const string SureveyID = "SureveyID";
			...
			static public string ToPropertyName(string columnName)
			{
				if(ht == null)
				{
					...
					ht[CategoryID] = _QuestionCategory.PropertyNames.CategoryID;
					ht[ArName] = _QuestionCategory.PropertyNames.ArName;
					ht[EnName] = _QuestionCategory.PropertyNames.EnName;
					ht[SureveyID] = _QuestionCategory.PropertyNames.SureveyID;
		...
		{  
			...
			static public string ToColumnName(string propertyName)
			{
				if(ht == null)
				{
					...
					ht[CategoryID] = _QuestionCategory.ColumnNames.CategoryID;
					ht[ArName] = _QuestionCategory.ColumnNames.ArName;
					ht[EnName] = _QuestionCategory.ColumnNames.EnName;
					ht[SureveyID] = _QuestionCategory.ColumnNames.SureveyID;
		...
		{  
            ...
            public const string SureveyID = "s_SureveyID";
		...
		public virtual int SureveyID
	    {
			get
	        {
				return base.Getint(ColumnNames.SureveyID);
			}
			set
	        {
				base.Setint(ColumnNames.SureveyID, value);
			}
		}
		...
		public virtual string s_SureveyID
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.SureveyID) ? string.Empty : base.GetintAsString(ColumnNames.SureveyID);
			}
			set
	        {
				if(string.Empty == value)
					this.SetColumnNull(ColumnNames.SureveyID);
				else
					this.SureveyID = base.SetintAsString(ColumnNames.SureveyID, value);
			}
		}
		...
		public class WhereClause
		{
			...
			public class TearOffWhereParameter
			{
				...
				public WhereParameter SureveyID
				{
					get
					{
							WhereParameter where = new WhereParameter(ColumnNames.SureveyID, Parameters.SureveyID);
							this._clause._entity.Query.AddWhereParameter(where);
							return where;
					}
				}
			...
			public WhereParameter SureveyID
		    {
				get
		        {
					if(_SureveyID_W == null)
	        	    {
						_SureveyID_W = TearOff.SureveyID;
					}
					return _SureveyID_W;
				}
			}
			...
			private WhereParameter _SureveyID_W = null;
		...
		public class AggregateClause
		{
			...
			public class TearOffAggregateParameter
			{
				...
				public AggregateParameter SureveyID
				{
					get
					{
							AggregateParameter aggregate = new AggregateParameter(ColumnNames.SureveyID, Parameters.SureveyID);
							this._clause._entity.Query.AddAggregateParameter(aggregate);
							return aggregate;
					}
				}
			...
			private AggregateParameter _SureveyID_W = null;
		...
		protected override IDbCommand GetInsertCommand() 
		{
			...
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_QuestionCategoryInsert]";
		...
		protected override IDbCommand GetUpdateCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_QuestionCategoryUpdate]";
		...
		protected override IDbCommand GetDeleteCommand()
		{
			...
			SqlCommand cmd = new SqlCommand();
			cmd.CommandType = CommandType.StoredProcedure;
			cmd.CommandText = "[" + this.SchemaStoredProcedure + "proc_QuestionCategoryDelete]";
		...
		private IDbCommand CreateParameters(SqlCommand cmd)
		{
			...
			p = cmd.Parameters.Add(Parameters.SureveyID);
			p.SourceColumn = ColumnNames.SureveyID;
			p.SourceVersion = DataRowVersion.Current;
